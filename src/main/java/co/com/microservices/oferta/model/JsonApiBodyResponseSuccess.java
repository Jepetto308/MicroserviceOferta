...
public class JsonApiBodyResponseSuccess   {
  @JsonProperty("data")
  @Valid
  private List<Oferta> data = new ArrayList<Oferta>();

  public JsonApiBodyResponseSuccess data(List<Oferta> data) {
    this.data = data;
    return this;
  }

  public JsonApiBodyResponseSuccess addDataItem(Oferta dataItem) {
